...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/17 11:22:34 by dessekinfem       #+#    #+#             */
/*   Updated: 2022/09/17 11:27:47 by dessekinfem      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rush(int x, int y)
{
	...
	while (i < y)
	{
		...
		while (j < x)
		{
			if (is_topleftcorner(i, j) || is_toprightcorner(i, j, x))
				ft_putchar('A');
			else if (is_bottomleftcorner(i, j, y))
				ft_putchar('C');
